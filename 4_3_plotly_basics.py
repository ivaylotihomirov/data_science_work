...
Original file is located at
    https://colab.research.google.com/drive/1WXHOIvvFSTmLg60k15j3BJPJwG2uk3jB
...
fig = px.scatter(data, x='Distance', y='DepTime', color_discrete_sequence=['red'])
fig.show()
...
fig = px.line(line_data, x = 'Month', y = 'ArrDelay', color_discrete_sequence = ['green'])
fig.show()
...
fig = px.histogram(data, x = 'ArrDelay', title = 'Arrival delays')
fig.update_xaxes(title_text='Arrival Delay')
...
fig = px.scatter(bub_data, x = 'Reporting_Airline', y = 'Flights', size = 'Flights', title = 'Airlines and Flights')
fig.update_layout(xaxis_title='Reporting Airline', yaxis_title='Flights')
fig.show()
